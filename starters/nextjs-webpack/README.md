# Nimiq Next.js Starter (Webpack)

Next.js starter with Nimiq blockchain using Webpack bundler (recommended for production).
...
```bash
npx degit onmax/nimiq-starter/starters/nextjs-webpack my-nimiq-app
